...
def runtests(persons,families):
    ...
    doPrint = input("Print persons info? (y/n) ")
    print()
    if doPrint in 'yY':
    ...
    print()
    doPrint = input("Print families info? (y/n) ")
    print()
    if doPrint in 'yY':
    ...
    print()
    doPrint = input("Print descendants? (y/n) ")
    if doPrint in 'yY':
        print()
    ...
    doPrint = input("Test isDescendant? (y/n) ")
    if doPrint in 'yY':
        print()
    ...
    print()
    doPrint = input("Test printAncestors? (y/n) ")
    print()
    if doPrint in 'yY':
    ...
    doPrint = input("Test printCousins? (y/n) ")
    if doPrint in 'yY':
        print()
